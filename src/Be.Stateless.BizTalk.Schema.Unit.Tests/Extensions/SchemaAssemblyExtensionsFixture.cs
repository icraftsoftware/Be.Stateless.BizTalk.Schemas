...
using Be.Stateless.BizTalk.Dummies.MyExtremelyLongAndBoringAndUnpromotableNamespaceThatWillCauseTheWholeBizTalkMessagingUniverseToCollapseCatastrophicallyAndHorrendously;
...
{
	public class SchemaAssemblyExtensionsFixture
	{
		[Fact]
