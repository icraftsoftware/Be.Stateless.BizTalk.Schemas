...
namespace Be.Stateless.BizTalk.Unit.Schema
{
	...
	public abstract class SchemaFixture<T> where T : SchemaBase, new()
	{
		...
		/// <summary>
		/// Loads and validates an XML file against the <typeparamref name="T"/>, <typeparamref name="T2"/> and <typeparamref
		/// name="T3"/> BizTalk Server schemas.
		/// </summary>
		/// <typeparam name="T2">
		/// A supplementary type of the BizTalk Server schema to validate against.
		/// </typeparam>
		...
		/// <summary>
		/// Validates an <see cref="Stream"/> against the <typeparamref name="T"/> and <typeparamref name="T2"/> BizTalk Server
		/// schemas.
		/// </summary>
		/// <typeparam name="T2">
		/// A supplementary type of the BizTalk Server schema to validate against.
		...
		/// <summary>
		/// Validates an <see cref="Stream"/> against the <typeparamref name="T"/>, <typeparamref name="T2"/> and <typeparamref
		/// name="T3"/> BizTalk Server schemas.
		/// </summary>
		/// <typeparam name="T2">
		/// A supplementary type of the BizTalk Server schema to validate against.
